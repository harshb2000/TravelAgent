...
from models.knowledge_state import KnowledgeState, DestinationResearch
...
def _make_wrapper(depth_in_ks: str | None = None, destination: str = "Tokyo"):
    ...
    return DestinationResearchWrapperTool(specialist, ks), specialist, ks, llm
...
def test_destination_research_wrapper_light_cache_hit():
    ...
    result = wrapper.execute(destination="Tokyo", depth="light", user_context="")
...
def test_destination_research_wrapper_upgrade_uses_3_iterations():
    ...
    wrapper.execute(destination="Tokyo", depth="full", user_context="")
...
def test_destination_research_wrapper_full_miss_light_uses_1_iteration():
    ...
    llm.chat.return_value = stop_msg(_light_json())
    wrapper.execute(destination="Tokyo", depth="light", user_context="")
