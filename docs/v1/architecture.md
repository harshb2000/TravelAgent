...
DestinationBudget:                    # all values USD; keys are LLM-generated, refined by UserContext
  ...
  summary:           str              # LLM-generated narrative; generated by BudgetSpecialist
                                      # in the same call as cost data
...
Returns full `DestinationBudget` — all cost categories as `CostWithAttribution` (amount + source_url per entry), summary.
